...
export const read = (petsId) => {
  return fetch(`http://localhost:4000/api/pets/${petsId}`, {
    method: "GET",
  })
    .then((response) => {
...
export const getPets = () => {
  return fetch(`${API}/pets/mascotas`, { method: "GET" })
    .then((response) => {
      console.log(response);
      return response.json();
    })
...
export const AdoptedByidPet = (petId, token, pet) => {
  return fetch(`http://localhost:4000/api/pets/createAdopted/${petId}`, {
    method: "POST",
    headers: {
